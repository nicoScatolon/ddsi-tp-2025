...
public class ConstructorSolicitudesEliminacion {
    ...
    public static SolicitudEliminarHecho constructorSolicitud (Hecho hecho, String razonDeEliminacion, String nombreContribuyente, String apellidoContribuyente) {
