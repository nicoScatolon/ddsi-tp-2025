...
class HechosServiceTest {
    ...
    private HechoInputDTO crearHechoInputDTO(String titulo, String descripcion, Double latitud, Double longitud, LocalDate fechaDeOcurrencia, String url) {
    ...
    public void testCrearHecho(){
        ...
        var hechoDTO1 = this.crearHechoInputDTO("1", "desc" ,12.33, 13.22, LocalDate.now(), "youtube/lol");
